    ...
    <section className={styles.aboutContainer}>
        <div className={styles.aboutWrapper}>
            <article className={styles.aboutContent}>
                ...
                <p>
                    HomeSynk was created with a mission to redefine property management through simplicity, innovation and efficiency. We believe managing properties should be effortless, transparent, and accessible for everyone involved—whether you're an owner, manager, or tenant. Our platform combines powerful features with a user-friendly design to support every aspect of property management. From tracking maintenance requests to managing lease agreements and payments, HomeSynk keeps everything in sync to save you time and maximize your property’s value.
